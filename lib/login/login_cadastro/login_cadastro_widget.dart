...
class LoginCadastroWidget extends StatefulWidget {
  const LoginCadastroWidget({Key? key}) : super(key: key);

  @override
  _LoginCadastroWidgetState createState() => _LoginCadastroWidgetState();
}
...
class _LoginCadastroWidgetState extends State<LoginCadastroWidget>
  ...
  void initState() {
    ...
    _model.nomeCriarController ??= TextEditingController();
    _model.nomeCriarFocusNode ??= FocusNode();
    ...
    _model.passwordCadastroConfirController ??= TextEditingController();
    _model.passwordCadastroConfirFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFF6C00A4),
        body: SafeArea(
          top: true,
          child: Stack(
            children: [
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/imgbin-himouto-umaru-chan-seinen-manga-please-tell-me-galko-chan-otaku-manga-YeUNxmtf988ibdTqw0GzsgPJh-removebg-preview.png',
                        height: 132.0,
                        fit: BoxFit.cover,
                      ),
                    ),
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'vpdr59nj' /* Partiu criar uma conta */,
                                                  ),
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '5o4rydhp' /* Preencha os campos abaixo */,
                                                    ),
                                                    textAlign: TextAlign.start,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                ...
                                                Padding(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .passwordCadastroConfirController,
                                                    focusNode: _model
                                                        .passwordCadastroConfirFocusNode,
                                                    textCapitalization:
                                                        TextCapitalization
                                                            .sentences,
                                                    obscureText: !_model
                                                        .passwordCadastroConfirVisibility,
                                                    decoration: InputDecoration(
                                                      labelText:
                                                          FFLocalizations.of(
                                                                  context)
                                                      ...
                                                      suffixIcon: InkWell(
                                                        ...
                                                        focusNode: FocusNode(
                                                            skipTraversal:
                                                                true),
                                                        child: Icon(
                                                          _model.passwordCadastroConfirVisibility
                                                              ? Icons
                                                                  .visibility_outlined
                                                              : Icons
                                                                  .visibility_off_outlined,
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '37ri0b98' /* Preencha os campos abaixo */,
                                                    ),
                                                    textAlign: TextAlign.start,
                                                    style: FlutterFlowTheme.of(
                                                            context)
              ...
              Align(
                alignment: AlignmentDirectional(0.0, 0.0),
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 740.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
                        FFLocalizations.of(context).getText(
                          'uyy6oefh' /* Entra ou cria uma conta ai meu... */,
                        ),

...
import 'schema/lista_de_animes_record.dart';
import 'schema/fotos_record.dart';
import 'schema/img_perfil_record.dart';
...
export 'schema/lista_de_animes_record.dart';
export 'schema/fotos_record.dart';
export 'schema/img_perfil_record.dart';
...
/// Functions to query ListaDeAnimesRecords (as a Stream and as a Future).
Future<int> queryListaDeAnimesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ListaDeAnimesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ListaDeAnimesRecord>> queryListaDeAnimesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ListaDeAnimesRecord.collection,
      ListaDeAnimesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ListaDeAnimesRecord>> queryListaDeAnimesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query ImgPerfilRecords (as a Stream and as a Future).
Future<int> queryImgPerfilRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ImgPerfilRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ImgPerfilRecord>> queryImgPerfilRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ImgPerfilRecord.collection,
      ImgPerfilRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ImgPerfilRecord>> queryImgPerfilRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>

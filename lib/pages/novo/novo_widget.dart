...
class NovoWidget extends StatefulWidget {
  ...
  @override
  _NovoWidgetState createState() => _NovoWidgetState();
}
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          'qbwiuioc' /* Clique para add uma imagem */,
                        ),
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      '8xl6i12q' /* Sua descrição do anime */,
                                    ),
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                    hintStyle: FlutterFlowTheme.of(context)
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            options: [
                              FFLocalizations.of(context).getText(
                                'p60ad5ei' /* Anime com dublagem😆 */,
                              ),
                              FFLocalizations.of(context).getText(
                                '0dw39n4q' /* Anime sem dublagem😔 */,
                              )
                            ],
                            onChanged: (val) =>
                      ...
                      Align(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            await ListaDeAnimesRecord.collection
                                .doc()
                                .set(createListaDeAnimesRecordData(
                                  nome: _model.textController1.text,
                                  genero: _model.dropDownValue,
                                  dublado: _model.dropDownDubValue,

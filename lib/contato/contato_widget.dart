                                    ...
                                    child: Container(
                                      ...
                                      child: Align(
                                        ...
                                        child: Container(
                                          ...
                                          child: Image.asset(
                                            'assets/images/Imagem_do_WhatsApp_de_2024-01-10_(s)_20.38.51_80d0d591.jpg',
                                            fit: BoxFit.cover,
                                  ...
                                  Flexible(
                                    child: Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '9xjrxzjc' /* Marcelo Nascimento - 21 anos */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium,
                                        ),
                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '32e3m9ku' /* INFORMAÇÕES DE CONTAT0: */,
                        ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                FlutterFlowIconButton(
                                  ...
                                  icon: Icon(
                                    Icons.chat,
                                    color: Color(0xFF29FF00),
                                    size: 24.0,
                                  ),
                                  onPressed: () async {
                                    if (isiOS) {
                                      await launchUrl(Uri.parse(
                                          "sms:${'marcelodev766@gmail.com'}&body=${Uri.encodeComponent('')}"));
                                    } else {
                                      await launchUrl(Uri(
                                        scheme: 'sms',
                                        path: 'marcelodev766@gmail.com',
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'zpz283lc' /* marcelodev766@gmail.com */,
                                  ),
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                ),
                ...
                child: Row(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/8b2f135d4d32eb0f155fffc2460436c3-removebg-preview.png',
                        width: 300.0,
                        height: 200.0,
                        fit: BoxFit.contain,
